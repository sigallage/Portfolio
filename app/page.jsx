          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-10">
            <div className="md:w-2/3">
              ...
              <p className="text-gray-300 text-lg mb-8 max-w-2xl">
                ...
                technologies. Passionate about creating clean, efficient code
              ...
              <div className="flex gap-4">
                ...
                <a href="/SIGallage.pdf" download>
                  <Button
                    variant="outline"
                    className="border-emerald-600 text-emerald-400 hover:bg-gray-800"
                  >
                    Download CV
                  </Button>
                </a>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-gray-300 mb-6">
                ...
                problems and creating intuitive, efficient applications.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Tabs defaultValue="languages" className="w-full">
            <TabsList className="grid w-full grid-cols-4 mb-8 bg-gray-800 h-12">
              <TabsTrigger
                value="languages"
                className="data-[state=active]:bg-gray-700 text-base font-medium py-3 px-4"
              >
                Languages
              </TabsTrigger>
              <TabsTrigger
